    ...
    export default {
        ...
        methods: {
            ...
            makeaffiligue(){
                ...
                this.csv="Sexe;Nom;Prenom;Date_Naissance;Adresse;CP;Ville;Date_certificat;Attestation_questionnaire;Competitif;Affiligue;Problemes\r";
                let certifdate="";
                let affiligue="";
                this.filteredgyms.forEach((gym) => {
                    ...
                    // for (var probleme in gym.problemes_short) {
                    //     alert(probleme);
                    // }
